...
CHAPTER 4 OVERALL ENTERPRISE ARCHITECTURE	9
4.1 Enterprise Architecture Context Diagram	9
4.2 Enterprise Architecture Model	9
4.2.1 Overall Architectural Considerations	9
4.3	Enterprise Architecture Concepts Overview and Definitions	10
4.4 Enterprise Architecture Principles Overview and Definitions	10
CHAPTER 5 ARCHITECTURES	10
5.1 Business Architecture	11
5.2 Information Architecture	12
5.2.1. Data Management	12
5.2.2. Data Storage	13
5.2.3. Data Processing and Analytics	13
5.2.4. Data Security	13
5.2.5. Data Integration	14
5.2.6. Compliance	14
5.2.7. Implementation Steps	15
5.3 Application Architecture	16
5.4 Technology Architecture	18
5.4.1. Introduction	18
5.4.2. Core Components	18
5.4.3. Detailed Architecture	20
5.4.4. Security Architecture	22
5.4.5. Conclusion	23
...
All the data, models, views and visualizations used in this document are stored in the companies Architecture Repository. This Architecture repository can be found on location www.github.com/mujeeburhman/alpha_ict_ea_project
...
4.3	Enterprise Architecture Concepts Overview and Definitions
